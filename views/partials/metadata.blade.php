...
{!! Theme::style('css/main.css') !!}
    {!! Theme::style('css/gcrid.css') !!}
    {!! Theme::style('css/reset.css') !!}
    {!! Theme::style('css/font-awesome.min.css') !!}
    {!! Theme::style('css/material-design-iconic-font.min.css') !!}
    {!! Theme::style('css/jquery.mCustomScrollbar.css') !!}
    {!! Theme::style('css/jquery.mCustomScrollbar.css') !!}
    {!! Theme::style('vendor/fancybox/dist/jquery.fancybox.css') !!}
    {!! Theme::style('fonts/stylesheet.css') !!}
    {!! Theme::style('css/style.css') !!}
    {!! Theme::style('css/slider.css') !!}
    {!! Theme::style('css/revealer.css') !!}
